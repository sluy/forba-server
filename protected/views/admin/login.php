   ...
   <img src="<?php echo Yii::app()->baseUrl.'/assets/images/logo@2x.png'; ?>">
     ...
     <div class="grey-box rounded3">
         ...
         if (empty($company_name)){
         	$company_name='Forba Back Office';
         }
         echo $company_name;
         ?>
         </h5>        
         ...
         <?php echo CHtml::hiddenField('action','login')?> 
          ...
          <?php echo t("LOG IN")?>    
           ...
           <div class="top20" style="text-align: right; ">
            <a href="javascript:;" class="admin_forgot_pass"><?php echo t("Forgot password")?>?</a>
           </div>
          ...
          <div class="top20" style="text-align: right; ">
            <a href="javascript:;" class="admin_back_login"><?php echo t("Login")?></a>
           </div>
