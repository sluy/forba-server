   ...
   <form class="row custom-pricing-box" method="POST" action="contact.php">
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                ...
                <select class="form-control contact-field"
                    name="topic"
                    id="contact-topic"
                    max-length="255"
                    onchange="ValidateContactForm()"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control contact-field"
                    ...
                    onchange="ValidateContactForm()"
                    onkeyup="ValidateContactForm()"
                    placeholder="Escriba aquí de manera específica su solicitud/sugerencia."></textarea>
            </div>
        </div>
